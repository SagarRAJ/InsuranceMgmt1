                                    ...
                                    <td> 
                                         <a href='#'>
                                            <button  class="btn-dark" onclick="getPolicy()">View Policy</button>
                                             ...
                                             <a href='#'>
                                            <button class="btn-dark" onclick="getDmv()">Dmv</button>
                                        </a>
                                        <c:if test="${(fnol.getApprovalByUnderWriterMessage()).equals('approved')}">
                                            <a href='Acceptio?claimNumber=${fnol.getClaimNumber()}&emailAddress=${fnol.getEmailAddress()}&policyNumber=${fnol.getPolicyNumber()}&vehicleNumber=${fnol.getVehicleNumber()}&description=${fnol.getDescription()}'>
                                            <button class="btn-dark">Accept</button>
                                        </a>
                                              <a href='Rejectio?claimNumber=${fnol.getClaimNumber()}&emailAddress=${fnol.getEmailAddress()}&policyNumber=${fnol.getPolicyNumber()}&vehicleNumber=${fnol.getVehicleNumber()}&description=${fnol.getDescription()}'>
