    ...
    <jsp:include page="menu.jsp"></jsp:include>
        ...
        <body>
            ...
            <div class="bootstrap-table bootstrap5">
                ...
                <div class="table-responsive" style="height: 300px; padding-bottom: 20px;">
                            ...
                            <c:forEach items="${FnolList}" var="fnol">
                                <tr>
                                    ...
                                    <td> 
                                        ...
                                        <a href='#'>
                                            <button  class="btn-dark" onclick="getPolicy()">View Policy</button>
                                        </a>

                                        <a href='#'>
                                            <button class="btn-dark" onclick="getDmv()">View Dmv</button>
                                        </a>
                                        <a href='Acceptunderwriter?claimNumber=${fnol.getClaimNumber()}&emailAddress=${fnol.getEmailAddress()}&policyNumber=${fnol.getPolicyNumber()}&vehicleNumber=${fnol.getVehicleNumber()}&description=${fnol.getDescription()}'>
                                            <button class="btn-dark">Accept</button>
                                        </a>
                                        <a href='Rejectunderwriter?claimNumber=${fnol.getClaimNumber()}&emailAddress=${fnol.getEmailAddress()}&policyNumber=${fnol.getPolicyNumber()}&vehicleNumber=${fnol.getVehicleNumber()}&description=${fnol.getDescription()}'>
