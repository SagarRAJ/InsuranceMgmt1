                            ...
                            <c:forEach items="${FnolList}" var="fnol">
                                <tr>
                                    ...
                                    <td> 
                                        ...
                                        <a href='Verify?claimNumber=${fnol.getClaimNumber()}&emailAddress=${fnol.getEmailAddress()}&policyNumber=${fnol.getPolicyNumber()}&vehicleNumber=${fnol.getVehicleNumber()}&description=${fnol.getDescription()}'>
